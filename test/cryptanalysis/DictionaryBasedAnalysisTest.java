...
public class DictionaryBasedAnalysisTest {
	...
	void applySubstitutionWithNullMessage() {
		assertThrows(NullPointerException.class, () -> DictionaryBasedAnalysis.applySubstitution(null, ENCODING_ALPHABET));
	}
	...
	void applySubstitutionWithNullAlphabet() {
		assertThrows(NullPointerException.class, () -> DictionaryBasedAnalysis.applySubstitution("BONJOUR", null));
	}
	...
	void guessAlphabetWithStartAlphabetNull(){
		...
		assertThrows(NullPointerException.class, () -> dba.guessApproximatedAlphabet(null));
	}
